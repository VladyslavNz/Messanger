...
-- CreateIndex
CREATE INDEX "PrivateChats_user1_id_idx" ON "PrivateChats"("user1_id");

-- CreateIndex
CREATE INDEX "PrivateChats_user2_id_idx" ON "PrivateChats"("user2_id");

-- CreateIndex
CREATE UNIQUE INDEX "PrivateChats_user1_id_user2_id_key" ON "PrivateChats"("user1_id", "user2_id");
